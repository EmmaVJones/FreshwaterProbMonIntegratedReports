...
author: "Jason Hill, Emma Jones, Lucy Baker & Mary Dail"
...
##### Table 2.4-6. VSCI/CPMI (`r IRrange`, n=`r max(filter(dat,Subpopulation=='IR2022'&Indicator=='VSCIVCPMI')$NResp)`) Scores below Virginia’s Assessment Thresholds ( +/- confidence limits).
```{r table2.4-6}
