...
# clean up workspace
rm(bugs);rm(conn);rm(field);rm(landcover);rm(lrbs);rm(metalsCCUresults);rm(probData)
```
...
* 2010 IR (2003-2008)
* 2008 IR (2001-2007)
* Panels (Phase 1= 2001-2010; Phase 2= 2010-2020) Kept Phase 1 same as 2018IR to balance n samples in window
* BioPanels (Phase 1 = 2001-2005; Phase 2 = 2006-2010; Phase 3 = 2011-2015; Phase 4 = 2016-2020)



Where possible, get metadata from previous years.

```{r}
filter(prob2020fin, StationID %in% finalSmash$StationID) %>% 
