...
change weight category to order




 
 run with VAHUSB??????? james and roanoke are ready

```{r}
unique(prob2020fin$SubBasin)
```
[1] "Basin"              "SubBasin"           "BayShed"            "BayPanel"           "EcoRegion"         
 [6] "BioRegion"          "Panel"              "BioPanel"           "Order"              "BasinSize"         
[11] "StreamSizeCat"      "StreamSizeCatPhase" "AREA_SQ_MILES"      "IR2008"             "IR2010"            
[16] "IR2012"             "IR2014"             "IR2016"             "IR2018"             "IR2020"       
...
```{r}
designStatusNew <- WQM_Stations_Filter <- read_excel('originalData/Wadeable_ProbMon_2019-2020_Final.xlsx', 
                                                  sheet = 'All20192020StationInfo') %>% 
  dplyr::select(DataSource:set)
```